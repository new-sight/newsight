...
def main():
    print("==================================================")
    # 한글 로그 출력
    print("[Main] 지난 일주일간 뉴스 대량 수집 및 AI 온톨로지 저장 파이프라인 가동")
    print("==================================================")

    # 1. 환경 변수로부터 수집 대상 정보 로드
    countries_env = os.getenv("TARGET_COUNTRIES", "KOREA")
    categories_env = os.getenv("TARGET_CATEGORIES", "TECHNOLOGY")
    limit_env = os.getenv("COLLECT_LIMIT", "50")
